...
class Configuration(commands.Cog):
    ...
    @commands.guild_only()
    @commands.command('config.set.category')
    ...
    @commands.command('config.set.configurator')
    @commands.guild_only()
    ...
    @commands.command('config.get.category')
    @commands.guild_only()
    ...
    @commands.command('config.get.configurator')
    @commands.guild_only()
    ...
    @commands.command('config.get.ticket-roles')
    @commands.guild_only()
    ...
    @commands.command('config.remove.ticket-roles')
    @commands.guild_only()
